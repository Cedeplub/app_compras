...
# O nome do servico reiniciado ao final e constante de producao. Uma copia
# deste script rodada da pasta de dev buildaria o front de dev e reiniciaria
# o servico "app_compras" de PRODUCAO. Por isso a trava: nada de escape.
